  ...
  <div id="wrap">
  	...
  	<div id="Foodmodal" class="modal hide fade">
  		...
  		<div class="modal-body">
  			<div class="tabbable tabs-left">
  				<ul class="nav nav-tabs">
  					<li class="active"><a href="#prod1" data-toggle="tab">Product 1</a></li>
  				...
  				<div class="tab-content">
  					<div class="tab-pane active" id="prod1">
  						<p>something about the first product that I don't really remember. anyway... stuff here...</p>
  					</div>
    ...
    <div class="navbar">
    	<ul class="nav">
    		<li>
    			<a href="#" role="button">Kemika Home</a>
    		</li>
		    <li class="dropdown">
		    ...
		    <li class="dropdown">
		    	<a class="dropdown-toggle" data-toggle="dropdown" href="#">Product Lists</a>
		    	<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
		    		<li><a tabindex="-1" href="#Foodmodal" role="button" data-toggle="modal">Food</a></li>
